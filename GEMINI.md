# FLIP_SI_BDMS — Gemini / Antigravity instructions

Read `AGENTS.md` and `CLAUDE.md` in this directory for repo facts. Shared workspace rules live in `../AGENTS.md` and `../CLAUDE.md`.
